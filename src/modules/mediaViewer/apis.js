...
export default {
    ...
    similar: 'https://www.bilibili.com/audio/music-service-c/web/song/similar', // 相似媒体
    ...
    videoStat: 'https://api.bilibili.com/x/web-interface/archive/stat', // 视频的各种数据 观看数 投币数 点赞数等
    videoTag: 'https://api.bilibili.com/x/web-interface/view/detail/tag', // 视频的标签
};
